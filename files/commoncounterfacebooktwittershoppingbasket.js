...
},getBasisId:function(){return window.script_basisID},replaceInternalLinks:function(b){var a=new RegExp('href\\s*=\\s*"https://web.archive.org/web/20191209122527/http://page-(\\d+)/"',"g");
...
this.initWidget(a[0]);jQuery.xLazyLoader({js:["//web.archive.org/web/20191209122527/https://platform.twitter.com/widgets.js"]});if("undefined"!==typeof(twttr)&&twttr.widgets){twttr.widgets.load()
...
var u=location.protocol.match(/https/);var w=/^.+\/profile_images/;var D="https://web.archive.org/web/20191209122527/https://s3.amazonaws.com/twitter_production/profile_images";
...
})},at:function(O){return O.replace(/\B[@???]([a-zA-Z0-9_]{1,20})/g,function(P,Q){return'@<a target="_blank" class="twtr-atreply" href="https://web.archive.org/web/20191209122527/http://twitter.com/intent/user?screen_name='+Q+'">'+Q+"</a>"
})},list:function(O){return O.replace(/\B[@???]([a-zA-Z0-9_]{1,20}\/\w+)/g,function(P,Q){return'@<a target="_blank" class="twtr-atreply" href="https://web.archive.org/web/20191209122527/http://twitter.com/'+Q+'">'+Q+"</a>"
})},hash:function(O){return O.replace(/(^|\s+)#(\w+)/gi,function(P,Q,R){return Q+'<a target="_blank" class="twtr-hashtag" href="https://web.archive.org/web/20191209122527/http://twitter.com/search?q=%23'+R+'">#'+R+"</a>"
...
}else{return""}}var P='<div class="twtr-tweet-wrap">         <div class="twtr-avatar">           <div class="twtr-img"><a target="_blank" href="https://web.archive.org/web/20191209122527/http://twitter.com/intent/user?screen_name='+Q.user+'"><img alt="'+Q.user+' profile" src="'+E(Q.avatar)+'"></a></div>         </div>         <div class="twtr-tweet-text">           <p>             <a target="_blank" href="https://web.archive.org/web/20191209122527/http://twitter.com/intent/user?screen_name='+Q.user+'" class="twtr-user">'+Q.user+"</a> "+Q.tweet+'             <em>            <a target="_blank" class="twtr-timestamp" time="'+Q.timestamp+'" href="https://web.archive.org/web/20191209122527/http://twitter.com/'+Q.user+"/status/"+Q.id+'">'+Q.created_at+'</a> &middot;            <a target="_blank" class="twtr-reply" href="https://web.archive.org/web/20191209122527/http://twitter.com/intent/tweet?in_reply_to='+Q.id+'">'+TwitterModule.msg.main_content.reply+'</a> &middot;             <a target="_blank" class="twtr-rt" href="https://web.archive.org/web/20191209122527/http://twitter.com/intent/retweet?tweet_id='+Q.id+'">'+TwitterModule.msg.main_content.retweet+'</a> &middot;             <a target="_blank" class="twtr-fav" href="https://web.archive.org/web/20191209122527/http://twitter.com/intent/favorite?tweet_id='+Q.id+'">'+TwitterModule.msg.main_content.favorite+"</a>             </em> "+O()+"           </p>         </div>       </div>";
...
var S=R+"api."+U+"/1/";var P=180000;var O=u?"https://web.archive.org/web/20191209122527/https://twitter-widgets.s3.amazonaws.com/j/1/default.gif":"https://web.archive.org/web/20191209122527/http://widgets.twimg.com/j/1/default.gif";
...
}this.widgetEl=n(this.id);if(X.id){J.add(this.widgetEl,"twtr-widget")}if(X.version>=2&&!TWTR1and1.Widget.hasLoadedStyleSheet){if(u){y.loadStyleSheet("https://web.archive.org/web/20191209122527/https://twitter-widgets.s3.amazonaws.com/j/2/widget.css",this.widgetEl)
}else{if(X.creator){y.loadStyleSheet("/stylesheets/widgets/widget.css",this.widgetEl)}else{y.loadStyleSheet("https://web.archive.org/web/20191209122527/http://widgets.twimg.com/j/2/widget.css",this.widgetEl)
...
if(W&&X){W.src=E(Y);X.href="https://web.archive.org/web/20191209122527/http://twitter.com/intent/user?screen_name="+this.username;jQuery(X).show();
...
},_getWidgetHtml:function(){var Y=this;function aa(){if(Y._isProfileWidget){return'<a target="_blank" href="https://web.archive.org/web/20191209122527/http://twitter.com/" class="twtr-profile-img-anchor"><img alt="profile" class="twtr-profile-img" src="'+O+'"></a>                      <h3></h3>                      <h4></h4>'
}else{return"<h3>"+Y.title+"</h3><h4>"+Y.subject+"</h4>"}}function X(){return Y._isFullScreen?" twtr-fullscreen":""
}var Z=u?"https://web.archive.org/web/20191209122527/https://twitter-widgets.s3.amazonaws.com/i/widget-logo.png":"https://web.archive.org/web/20191209122527/http://widgets.twimg.com/i/widget-logo.png";
if(this._isFullScreen){Z="https://web.archive.org/web/20191209122527/https://twitter-widgets.s3.amazonaws.com/i/widget-logo-fullscreen.png"}var W='<div class="twtr-doc'+X()+'" style="width: '+this.wh[0]+';">            <div class="twtr-bd">              <div class="twtr-timeline" style="height: '+this.wh[1]+';">                <div class="twtr-tweets">                  <div class="twtr-reference-tweet"></div>                  <!-- tweets show here -->                </div>              </div>            </div>          </div>';
...
}if(j.paypal){var i="<a href='https://web.archive.org/web/20191209122527/https://www.paypal.com/us/cgi-bin/webscr?business="+encodeURIComponent(jQuery("#ppForm #business").val())+"&item_name="+encodeURIComponent(jQuery("#ppForm #business").val())+"&currency_code="+escape(jQuery("#ppForm #currency_code").val())+"&amount="+encodeURIComponent(jQuery("#ppForm #amount").val())+"&cmd="+encodeURIComponent(jQuery("#ppForm #cmd").val())+"' target='_blank'>"+b.msg_main.paypal_link+"</a>";
...
/*
     FILE ARCHIVED ON 12:25:27 Dec 09, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:18:27 Aug 13, 2020.
...
playback timings (ms):
  esindex: 0.015
  RedisCDXSource: 106.554
  PetaboxLoader3.datanode: 931.077 (4)
  captures_list: 845.285
  CDXLines.iter: 23.767 (3)
  load_resource: 476.554
  LoadShardBlock: 710.886 (3)
  PetaboxLoader3.resolve: 140.759
