...
},getBasisId:function(){return window.script_basisID},replaceInternalLinks:function(b){var a=new RegExp('href\\s*=\\s*"https://web.archive.org/web/20170123212429/http://page-(\\d+)/"',"g");
...
},validateConfig:function(){return true},getConfigData:function(){var b=this.getConfigJQ();var a={like_box:b.find('input[name="like_box"]').is(":checked")?1:0,page_url:b.find('input[name="page_url"]').val(),show_faces:b.find('input[name="show_faces"]').is(":checked")?1:0,show_stream:b.find('input[name="show_stream"]').is(":checked")?1:0,like_button:b.find('input[name="like_button"]').is(":checked")?1:0,color:b.find('select[name="color"]').val()};
return a},_injectFacebookScript:function(e,a,f){var c,b=e.getElementsByTagName(a)[0];if(e.getElementById(f)){return
}c=e.createElement(a);c.id=f;c.src="//web.archive.org/web/20170123212429/http://connect.facebook.net/"+(FacebookModule.msg.all&&FacebookModule.msg.all.facebookLocale?FacebookModule.msg.all.facebookLocale:apsinth.lang)+"/sdk.js#xfbml=1&version=v2.6";
...
this._injectFacebookScript(document,"script","facebook-jssdk");FacebookModule.jsInjected=true}},_getAppId:function(){return diy.editor.getFacebookAppId()
},_initMainView:function(){var f=this.getMainJQ();var b=f.width();var d=f.find(".fb-page");var a=f.find(".fb-like");
if(d.length>0||a.length>0){this._initFacebookSDK()}if(window.FB){this.initMainViewWidgets(d,a,b)}else{var g=document.getElementById("facebook-jssdk");
var e=this;var c=function(){if(!this.readyState||this.readyState=="loaded"||this.readyState=="complete"){e.toHandler(function(){e.initMainViewWidgets(d,a,b)
})()}};jQuery(g).load(c);jQuery(g).bind("readystatechange",c)}},initMainViewWidgets:function(c,b,a){if(c){c.attr("data-width",a);
c.css("overflow","hidden")}if(b){b.attr("data-width",a);var d=35;if(a<225){d=20;b.attr("data-layout","button_count")
}else{if(a<450){d=60}}FB.Event.subscribe("xfbml.render",function(){var f={width:a+"px",height:d+"px"};
b.find("iframe").add(b).css(f);c.find("iframe").add(c).css("width",a+"px")})}if(this.mode=="admin"&&window.FB){var e=this._getAppId();
window.FB.init({version:"v2.6",xfbml:true,appId:e,});window.FB.XFBML.parse(this.getMainJQ().get(0))}},_initConfigView:function(){var a=this.getConfigJQ();
this.disableToggleInit("like_box","likeBox");this.disableToggleInit("like_button","likeButton");jQuery(".wrapper-color",a).diy_combobox({editable:false});
a.find(".form-item input.checkbox").diy_checkbox();a.find("input[type='text'], textarea").diy_textField();
this.form=a.find("form").diy_form({messageTarget:this.errorTarget})},disableToggleInit:function(a,b){var e=this.getConfigJQ();
var d=e.find('input[name="'+a+'"]');var c=e.find("."+b+" .facebook-optionset-disable input, ."+b+" .facebook-optionset-disable select");
...
}else{c.prop("disabled",true);c.filter('input[type="checkbox"]').diy_checkbox({disabled:true})}})},numberFormat:function(b){b+="";
x=b.split(".");x1=x[0];x2=x.length>1?"."+x[1]:"";var a=/(\d+)(\d{3})/;while(a.test(x1)){x1=x1.replace(a,"$1,$2")
}return x1+x2}});
...
this.initWidget(a[0]);jQuery.xLazyLoader({js:["//web.archive.org/web/20170123212429/http://platform.twitter.com/widgets.js"]});if("undefined"!==typeof(twttr)&&twttr.widgets){twttr.widgets.load()
...
var u=location.protocol.match(/https/);var w=/^.+\/profile_images/;var D="https://web.archive.org/web/20170123212429/https://s3.amazonaws.com/twitter_production/profile_images";
...
})},at:function(O){return O.replace(/\B[@???]([a-zA-Z0-9_]{1,20})/g,function(P,Q){return'@<a target="_blank" class="twtr-atreply" href="https://web.archive.org/web/20170123212429/http://twitter.com/intent/user?screen_name='+Q+'">'+Q+"</a>"
})},list:function(O){return O.replace(/\B[@???]([a-zA-Z0-9_]{1,20}\/\w+)/g,function(P,Q){return'@<a target="_blank" class="twtr-atreply" href="https://web.archive.org/web/20170123212429/http://twitter.com/'+Q+'">'+Q+"</a>"
})},hash:function(O){return O.replace(/(^|\s+)#(\w+)/gi,function(P,Q,R){return Q+'<a target="_blank" class="twtr-hashtag" href="https://web.archive.org/web/20170123212429/http://twitter.com/search?q=%23'+R+'">#'+R+"</a>"
...
}else{return""}}var P='<div class="twtr-tweet-wrap">         <div class="twtr-avatar">           <div class="twtr-img"><a target="_blank" href="https://web.archive.org/web/20170123212429/http://twitter.com/intent/user?screen_name='+Q.user+'"><img alt="'+Q.user+' profile" src="'+E(Q.avatar)+'"></a></div>         </div>         <div class="twtr-tweet-text">           <p>             <a target="_blank" href="https://web.archive.org/web/20170123212429/http://twitter.com/intent/user?screen_name='+Q.user+'" class="twtr-user">'+Q.user+"</a> "+Q.tweet+'             <em>            <a target="_blank" class="twtr-timestamp" time="'+Q.timestamp+'" href="https://web.archive.org/web/20170123212429/http://twitter.com/'+Q.user+"/status/"+Q.id+'">'+Q.created_at+'</a> &middot;            <a target="_blank" class="twtr-reply" href="https://web.archive.org/web/20170123212429/http://twitter.com/intent/tweet?in_reply_to='+Q.id+'">'+TwitterModule.msg.main_content.reply+'</a> &middot;             <a target="_blank" class="twtr-rt" href="https://web.archive.org/web/20170123212429/http://twitter.com/intent/retweet?tweet_id='+Q.id+'">'+TwitterModule.msg.main_content.retweet+'</a> &middot;             <a target="_blank" class="twtr-fav" href="https://web.archive.org/web/20170123212429/http://twitter.com/intent/favorite?tweet_id='+Q.id+'">'+TwitterModule.msg.main_content.favorite+"</a>             </em> "+O()+"           </p>         </div>       </div>";
...
var S=R+"api."+U+"/1/";var P=180000;var O=u?"https://web.archive.org/web/20170123212429/https://twitter-widgets.s3.amazonaws.com/j/1/default.gif":"https://web.archive.org/web/20170123212429/http://widgets.twimg.com/j/1/default.gif";
...
}this.widgetEl=n(this.id);if(X.id){J.add(this.widgetEl,"twtr-widget")}if(X.version>=2&&!TWTR1and1.Widget.hasLoadedStyleSheet){if(u){y.loadStyleSheet("https://web.archive.org/web/20170123212429/https://twitter-widgets.s3.amazonaws.com/j/2/widget.css",this.widgetEl)
}else{if(X.creator){y.loadStyleSheet("/stylesheets/widgets/widget.css",this.widgetEl)}else{y.loadStyleSheet("https://web.archive.org/web/20170123212429/http://widgets.twimg.com/j/2/widget.css",this.widgetEl)
...
if(W&&X){W.src=E(Y);X.href="https://web.archive.org/web/20170123212429/http://twitter.com/intent/user?screen_name="+this.username;jQuery(X).show();
...
},_getWidgetHtml:function(){var Y=this;function aa(){if(Y._isProfileWidget){return'<a target="_blank" href="https://web.archive.org/web/20170123212429/http://twitter.com/" class="twtr-profile-img-anchor"><img alt="profile" class="twtr-profile-img" src="'+O+'"></a>                      <h3></h3>                      <h4></h4>'
}else{return"<h3>"+Y.title+"</h3><h4>"+Y.subject+"</h4>"}}function X(){return Y._isFullScreen?" twtr-fullscreen":""
}var Z=u?"https://web.archive.org/web/20170123212429/https://twitter-widgets.s3.amazonaws.com/i/widget-logo.png":"https://web.archive.org/web/20170123212429/http://widgets.twimg.com/i/widget-logo.png";
if(this._isFullScreen){Z="https://web.archive.org/web/20170123212429/https://twitter-widgets.s3.amazonaws.com/i/widget-logo-fullscreen.png"}var W='<div class="twtr-doc'+X()+'" style="width: '+this.wh[0]+';">            <div class="twtr-bd">              <div class="twtr-timeline" style="height: '+this.wh[1]+';">                <div class="twtr-tweets">                  <div class="twtr-reference-tweet"></div>                  <!-- tweets show here -->                </div>              </div>            </div>          </div>';
...
}if(j.paypal){var i="<a href='https://web.archive.org/web/20170123212429/https://www.paypal.com/us/cgi-bin/webscr?business="+encodeURIComponent(jQuery("#ppForm #business").val())+"&item_name="+encodeURIComponent(jQuery("#ppForm #business").val())+"&currency_code="+escape(jQuery("#ppForm #currency_code").val())+"&amount="+encodeURIComponent(jQuery("#ppForm #amount").val())+"&cmd="+encodeURIComponent(jQuery("#ppForm #cmd").val())+"' target='_blank'>"+b.msg_main.paypal_link+"</a>";
...
/*
     FILE ARCHIVED ON 21:24:29 Jan 23, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 20:32:50 Aug 13, 2020.
...
/*
playback timings (ms):
  captures_list: 151.184
  PetaboxLoader3.resolve: 172.187 (2)
  LoadShardBlock: 115.65 (3)
  exclusion.robots: 0.229
  CDXLines.iter: 25.656 (3)
  exclusion.robots.policy: 0.212
  PetaboxLoader3.datanode: 81.518 (4)
  RedisCDXSource: 4.684
  load_resource: 170.107
  esindex: 0.009
*/